...
public class ActionsForShipCommand implements ICommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (actionUpdate != null){
            page = new ToUpdateShipCard().execute(request, response);
        }
        if (actionDelete != null){
            page = new DeleteShipCommand().execute(request, response);
        }
        return page;
    }
}
