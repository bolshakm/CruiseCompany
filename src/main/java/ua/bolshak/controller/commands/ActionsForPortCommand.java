...
public class ActionsForPortCommand implements ICommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (actionUpdate != null){
            page = new UpdatePortCommand().execute(request, response);
        }
        if (actionDelete != null){
            page = new DeletePortCommand().execute(request, response);
        }
        return page;
    }
}
